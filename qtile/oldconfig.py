...
keys = [
    ...
    Key([mod], "Return", lazy.spawn("rofi -modi drun -show drun -config ~/.config/rofi/rofidmenu.rasi"), desc='Rofi'),
...
def init_widgets_list():
    widgets_list = [
        ...
        # widget.Sep(linewidth = 0, padding = 6, foreground = colors[2], background = colors[9]),
        # widget.AGroupBox(
        #     # foreground = colors[1],
        #     # background = "#ff0000",
        #     # border = None,
...
#                         'Button1': lambda: qtile.cmd_spawn('brave https://calendar.proton.me/u/0/'),
#                         'Button3': lambda: qtile.cmd_spawn('brave https://calendar.google.com/calendar/u/0/r'),
#                         'Button2': lambda: qtile.cmd_spawn('brave https://mail.proton.me/u/0/inbox'),
#                     },
#                 ),
#             ],
#             32,
